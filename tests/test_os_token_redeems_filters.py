...
URL_1 = f"{BASE_URL}api/v1/events/GetByFiltersOsTokenRedeemedsIdx1"
URL_2 = f"{BASE_URL}api/v1/events/GetByFiltersOsTokenRedeemedsIdx2"
URL_3 = f"{BASE_URL}api/v1/events/GetByFiltersOsTokenRedeemedsIdx3"
