...
URL_1 = f"{BASE_URL}api/v1/events/GetByFiltersOsTokenBurnedsIdx1"
URL_2 = f"{BASE_URL}api/v1/events/GetByFiltersOsTokenBurnedsIdx2"
URL_3 = f"{BASE_URL}api/v1/events/GetByFiltersOsTokenBurnedsIdx3"
